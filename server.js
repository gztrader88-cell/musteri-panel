...
// Lot Sistemi sayfasi
// =====================================================
// LOT MIGRATION (TEK SEFERLIK - ISIN BITINCE BU BLOGU SIL)
// Sadece aktif 71 musteri icin - sadece UPDATE, EKLEME YOK
// =====================================================
app.get('/api/lot-migration-fix', async (req, res) => {
  const aktifMusteriler = {
    '7197904': 1523311, '7197832': 503014,  '7198743': 1126907, '7189653': 634691,
    '7196328': 342527,  '7197811': 331659,  '7203341': 1744604, '7211932': 282695,
    '7220676': 1103597, '7220548': 1016764, '7220666': 483358,  '7220695': 351899,
    '7220690': 343779,  '7222015': 536328,  '7230772': 1093977, '7221998': 353130,
    '7227601': 439102,  '7227709': 361588,  '7231831': 637862,  '7231995': 419262,
    '7232074': 414636,  '7229339': 307420,  '7231837': 470000,  '7232402': 1815050,
    '7234237': 251551,  '7149847': 305902,  '7235405': 451037,  '53659':   224765,
    '7236189': 138362,  '7236065': 367809,  '7152100': 367088,  '7192610': 331946,
    '7236029': 238340,  '7236134': 304809,  '7236469': 240700,  '7237612': 262614,
    '7237528': 570704,  '7237754': 684012,  '7237833': 261057,  '7237217': 232014,
    '7237934': 252910,  '7238855': 419045,  '7238958': 229145,  '7236167': 227207,
    '7239339': 254579,  '7239024': 269646,  '7236798': 251903,  '7235550': 248869,
    '7240771': 1079144, '7240908': 246036,  '7195843': 280666,  '7241368': 375996,
    '7241996': 269515,  '7237486': 290936,  '53618':   223994,  '7242011': 237317,
    '7243614': 238819,  '7243582': 412399,  '7243488': 505147,  '7243619': 958948,
    '7244161': 224212,  '7189496': 310142,  '99303048':1793230, '7245343': 235890,
    '7236080': 215126,  '7237690': 221854,  '7247038': 458135,  '53658':   357839,
    '7149714': 461685,  '7133687': 142382,  '7134170': 216239
  };
  ...
  try {
    for (const [hesap_no, deger] of Object.entries(aktifMusteriler)) {
      const mevcut = await pool.query('SELECT override, baslangic_parasi FROM lot_referans WHERE hesap_no = $1', [hesap_no]);

      if (mevcut.rows.length === 0) {
        notFound++;
        log.push(`BULUNAMADI: ${hesap_no} (lot_referans tablosunda kayit yok, atlandi)`);
      } else if (mevcut.rows[0].override) {
        skipped++;
        log.push(`ATLANDI (manuel override): ${hesap_no}`);
      } else {
        const eski = parseFloat(mevcut.rows[0].baslangic_parasi) || 0;
        await pool.query(
          `UPDATE lot_referans SET baslangic_parasi = $1, son_guncelleme = NOW(), son_guncelleyen = 'robot_kodu_migration'
           WHERE hesap_no = $2`,
          [deger, hesap_no]
        );
        updated++;
    ...
    res.json({
      ok: true,
      ozet: { toplam: Object.keys(aktifMusteriler).length, updated, notFound, skipped },
      detay: log
    });
  } catch (err) {
