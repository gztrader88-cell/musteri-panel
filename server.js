...
<div class="container">
  <div class="stats-grid">
    ...
    <div class="stat-card"><div class="stat-val" id="sYillik" style="color:#1a73e8">-</div><div class="stat-lbl">Yillik Ortalama</div></div>
...
async function init(){
  ...
  var gunSayisi=extData.length;
  var yillikPct=(Math.pow(son/ilk,365/gunSayisi)-1)*100;
  ...
  document.getElementById("sYillik").textContent=(yillikPct>=0?"+":"")+yillikPct.toFixed(1)+"%";
  document.getElementById("sYillik").style.color=yillikPct>=0?"#16a34a":"#dc2626";
  ...
  var colors=[];
  for(var p=0;p<values.length;p++) colors.push(p<splitIdx?"#1a73e8":"#f59e0b");
  new Chart(document.getElementById("chartBakiye"),{
    ...
    options:{
      ...
      plugins:{legend:{display:false},tooltip:{callbacks:{label:function(ctx){return new Intl.NumberFormat("tr-TR").format(Math.round(ctx.raw));}}}},
      scales:{
